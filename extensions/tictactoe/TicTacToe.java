...
public class TicTacToe  {
	...
	public static void verifyValidRow(int row) {
		if(row > 2 || row < 0){throw new IllegalArgumentException("You must implement this method");}
		else return;
	}
	...
	public static void verifyValidCol(int col) {
		if(col > 2 || col < 0){throw new IllegalArgumentException("You must implement this method");}
		else return;
	}
	 ...
	 * @param board A 3x3 String[][] array
	 * @return true if the board contains some win for the specified player
	 */
	public static boolean winFor(String player, String[][] board) {
		...
		if(newBoard[0][0] == player && newBoard[0][1] == player && newBoard[0][2] == player){return true;}
		if(newBoard[0][0] == player && newBoard[1][1] == player && newBoard[2][2] == player){return true;}
		if(newBoard[0][0] == player && newBoard[1][0] == player && newBoard[2][0] == player){return true;}
		if(newBoard[2][0] == player && newBoard[1][1] == player && newBoard[0][2] == player){return true;}
		if(newBoard[0][0] == player && newBoard[0][1] == player && newBoard[0][2] == player){return true;}
		if(newBoard[0][2] == player && newBoard[1][2] == player && newBoard[2][2] == player){return true;}
		if(newBoard[2][0] == player && newBoard[2][1] == player && newBoard[2][2] == player){return true;}
		if(newBoard[0][1] == player && newBoard[1][1] == player && newBoard[2][1] == player){return true;}
		return true; // FIXME
	}
